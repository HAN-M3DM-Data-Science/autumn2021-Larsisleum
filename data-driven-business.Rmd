...
I couldn't find a "standard" list of steps that is agreed upon within the branche. But when creating a business model for a mature data driven business i think creating a foundation and structural guidelines around the things the company is doing with data should be the focus. I did find six steps that are described in a research paper from the University of Cambridge and i think  these questions are key to be answered and can give a nice foundation that the data driven business can be build opon. Altho i do think it has value that this does keep getting monitored (Externally aswell) and managed. These are the six questions:
